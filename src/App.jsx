        ...
        {isOpen ? (
          ...
          >
            <motion.div
              ...
              className="soft-outline relative flex h-[calc(100dvh-0.5rem)] max-h-[calc(100dvh-0.5rem)] w-full max-w-[430px] flex-col overflow-hidden rounded-[2rem] border border-white/70 bg-[radial-gradient(circle_at_top_left,_rgba(240,255,251,0.98),_rgba(255,255,255,0.98)_38%,_rgba(238,247,255,0.98)_100%)] px-4 py-4 shadow-[0_26px_70px_-28px_rgba(19,56,104,0.42)] sm:h-auto sm:max-h-[min(560px,calc(100svh-2rem))] sm:max-w-[460px] sm:px-5 sm:py-5"
            >
              <button
                type="button"
              ...
              <div className="border-t border-white/65 bg-white/72 px-1 pb-[calc(env(safe-area-inset-bottom)+0.35rem)] pt-3 backdrop-blur-sm sm:px-0 sm:pb-1">
                <button
                  type="submit"
                  form="popup-consultation-form"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-brand-700 via-brand-600 to-mint-500 px-5 py-3 text-[0.92rem] font-semibold text-white shadow-float transition hover:-translate-y-0.5"
                >
